...
sr2_assert( 3 === count( $collection ) && empty( $collection[0]['imagesrcset'] ), 'static Signature preloads the three art-directed arrival tiers, never a srcset hint the <picture> ignores' );
