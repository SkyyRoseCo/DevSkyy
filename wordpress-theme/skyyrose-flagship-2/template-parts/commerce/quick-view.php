 ...
 * invents price, stock, media, or collection facts. Markup follows the house
 * dialog language (.sr2-dialog-head, .sr2-icon-button, .sr2-control).
 *
...
<dialog id="sr2-quick-view-dialog" class="sr2-quick-view" aria-labelledby="sr2-quick-view-title">
	<div class="sr2-quick-view__panel product">
		...
		<div class="sr2-quick-view__copy">
			<div class="sr2-dialog-head sr2-quick-view__head">
				<p class="sr2-index sr2-quick-view__collection" data-quick-view-collection><?php esc_html_e( 'Piece from the house', 'skyyrose-flagship-2' ); ?></p>
				<form method="dialog" class="sr2-quick-view__close-form">
					<button type="submit" class="sr2-icon-button sr2-quick-view__close" aria-label="<?php esc_attr_e( 'Close quick view', 'skyyrose-flagship-2' ); ?>">×</button>
				</form>
			</div>
			...
			<div class="sr2-quick-view__actions">
				<a class="sr2-control sr2-control--primary" href="#" data-quick-view-url><?php esc_html_e( 'Enter the piece', 'skyyrose-flagship-2' ); ?></a>
				<button type="button" class="sr2-control sr2-control--quiet" data-quick-view-dismiss><?php esc_html_e( 'Keep exploring', 'skyyrose-flagship-2' ); ?></button>
			</div>
		</div>
	</div>
</dialog>
