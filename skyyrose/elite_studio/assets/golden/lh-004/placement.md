...
CANONICAL LOGO AND DECORATION CONTRACT — SKU lh-004
Source: wordpress-theme/skyyrose-flagship/data/logo-registry.json
This registry is the sole authority for artwork, lettering, placements and decoration dimensions. It overrides conflicting dossier prose, cached briefs and prior prompt corrections. Preserve founder specifications exactly; do not infer dimensions or add collection logos to blank garments.
Apply only decorations visible from the requested garment view; do not move back decorations to the front or change the requested composition.
{
  "placements": [
    {
      "logo_id": "love-hurts-full-lettering",
      "notes": "User-confirmed 2026-04-20: Love Hurts graffiti lettering goes on the front.",
      "position": "front_across",
      "size_inches": 12,
      "technique": "embroidered_or_applique"
    },
    {
      "logo_id": "red-roses-cloud-cluster",
      "notes": "Re-corrected 2026-05-27 per founder: red-roses-cloud-cluster is the correct LH inside-hood pattern. The 2026-05-25 switch to heart-rose-composite was incorrect.",
      "position": "inside_hood",
      "technique": "sublimated"
    },
    {
      "logo_id": "heart-rose-composite",
      "notes": "User-confirmed 2026-04-20: heart-and-rose composite centered on back.",
      "position": "back_center",
      "size_inches": 10,
      "technique": "embroidered_or_printed"
    }
  ]
}
...
- NO sherpa fabric. Preserve the founder-confirmed satin appearance; fiber composition is unspecified.
